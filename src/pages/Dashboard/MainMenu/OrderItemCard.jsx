...
const OrderItemCard = ({ item, handleDelete }) => {
  ...
  const setIncrease = (id) => {
    ...
    storesItem.map((item) => {
      // console.log(item.singleData.qty);

      if (item.singleData.id === id) {
        item.singleData.qty = parseInt(value) + 1;
        ...
        <div>
          ...
          <div className='flex items-center'>
            ...
            <div className='input-group mr-[10px]'>
              <button onClick={() => setDecrease(item.singleData.id)}>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='12'
                  height='3'
              ...
              <p>{value}</p>
              <button onClick={() => setIncrease(item.singleData.id)}>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='11'
                  height='11'
