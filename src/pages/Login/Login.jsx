...
const Login = () => {
  ...
  return (
    <div className=' flex lg:justify-center items-center  login_bg relative'>
      ...
      <form onSubmit={handleSubmit} className=' lg:py-[60px] px-[20px] lg:px-[70px] login'>
        ...
        <div className='md:px-12 lg:px-0'>
          ...
          <button type="submit" className=' mt-[30px] w-full rounded-full font-medium text-[19px] bg-[#F06D23] py-[15px] text-white mb-[53px]'>
            Log in
          </button>
